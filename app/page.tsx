...
export default function Home(){
 ...
 return <main>
  ...
  <section id="visit" className="visit"><div><p className="eyebrow">COME THROUGH</p><h2>FIND<br/><em>NEPHEWS.</em></h2><p>4380 Dorris St<br/>Chattanooga, TN 37410</p><div className="actions"><a className="button" href="https://www.google.com/maps/search/?api=1&query=4380+Dorris+St+Chattanooga+TN+37410" target="_blank" rel="noreferrer">Get Directions</a><a className="button ghost" href="tel:+14238022753">Call Us</a></div></div><div className="hours"><p className="eyebrow">HOURS</p><p>Hours can change — call ahead for today's opening time and kitchen hours.</p><p className="big">CHATTANOOGA<br/>TN</p></div></section>
